...
const Resume = forwardRef((props, ref) => {
  ...
  const sectionDiv = {
    ...
    [sections.skills]: (
      <div className={`${styles.section} ${info.skills?.sectionTitle ? "" : styles.hidden}`}>
    ...
    [sections.languages]: (
      <div className={`${styles.section} ${info.languages?.sectionTitle ? "" : styles.hidden}`}>
        <div className={styles.sectionTitle}>{info.languages?.sectionTitle}</div>
        <div className={styles.content}>
  ...
  useEffect(() => {
    setColumns([
      [sections.project, sections.education, sections.summary, sections.skills, sections.languages],
