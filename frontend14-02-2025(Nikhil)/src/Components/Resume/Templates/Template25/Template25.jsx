        ...
        <div className={styles.contact}>
          {info.basicInfo.email && (
            <p>
              ...
              <br></br>{info.basicInfo.email}
            </p>
          )}
          {info.basicInfo.phone && (
            <p>
              <FaPhone className={styles.icon} /> <br></br>{info.basicInfo.phone}
            </p>
          )}
          {info.basicInfo.github && (
            <p>
              <FaGithub className={styles.icon} />{" "}
              <a href={info.basicInfo.github} target="_blank" rel="noopener noreferrer">
              <br></br>{info.basicInfo.github}
              </a>
            </p>
          )}
          {info.basicInfo.linkedin && (
            <p>
              ...
              <a href={info.basicInfo.linkedin} target="_blank" rel="noopener noreferrer">
              <br></br>{info.basicInfo.linkedin}
              </a>
            </p>
          )}
        </div>
